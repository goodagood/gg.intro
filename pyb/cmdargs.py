...
# a list of keywords, it tell do..py what to do, 2018 0913
parser.add_argument('wordlist', type=str, nargs='+', help="at first a list of keywords")
...
#parser.add_argument('-w', '--what', help="give key words of what to do, compile, copy, css, js")
